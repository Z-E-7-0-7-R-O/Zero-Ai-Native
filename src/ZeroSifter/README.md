...
<div align="center">
  ...
  <p><i>Figure: ZeroSifter Operational Dashboard - Real-time Vulnerability Phasing via IOCP. Note: All displayed vulnerability data and target IP addresses are taken from live test environments, which validates the engine's ability to detect real, active security flaws. No simulations or fake data were used in this validation.</i></p>
</div>
